...
class PCA9536:
    ...
    def pin_mode(self, pin, mode):
        ...
        self.bus.write_byte_data(self.address, self.__CONF_PORT_ADDR, self.__CONF_PORT_VAL)
        time.sleep(0.005)
    ...
    def digital_write(self, pin, value):
        ...
        if v:
            ...
            if (self.debug):
                print(">>Pin:{}  Value:{}".format(int(math.log2(p)), v))
                print(">>>OUTPUT_PORT_1:{0:b}".format(self.__OUTPUT_PORT_VAL))
        self.bus.write_byte_data(self.address, self.__OUTPUT_PORT_ADDR, self.__OUTPUT_PORT_VAL)
        time.sleep(0.005)
